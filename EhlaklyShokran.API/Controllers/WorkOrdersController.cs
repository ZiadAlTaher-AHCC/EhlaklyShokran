...
using EhlaklyShokran.Application.Features.Scheduling.Queries.GetDailyScheduleQuery;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.AssignLabor;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.CreateWorkOrder;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.DeleteWorkOrder;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.RelocateWorkOrder;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.UpdateOrderState;
using EhlaklyShokran.Application.Features.WorkOrders.Commands.UpdateWorkOrderBarberTasks;
using EhlaklyShokran.Application.Features.WorkOrders.Dtos;
using EhlaklyShokran.Application.Features.WorkOrders.Queries.GetWorkOrderByIdQuery;
using EhlaklyShokran.Application.Features.WorkOrders.Queries.GetWorkOrders;
...
public sealed class WorkOrdersController(ISender sender) : ApiController
{
    ...
    [HttpPut("{workOrderId:guid}/Barber-task")]
    [Authorize(Roles = nameof(Role.Manager))]
    [ProducesResponseType(StatusCodes.Status204NoContent)]
    [ProducesResponseType(StatusCodes.Status404NotFound)]
    public async Task<IActionResult> UpdateBarberTasks(Guid workOrderId, ModifyBarberTaskRequest request, CancellationToken ct)
    {
        var command = new UpdateWorkOrderBarberTasksCommand(workOrderId, request.BarberTaskIds);
