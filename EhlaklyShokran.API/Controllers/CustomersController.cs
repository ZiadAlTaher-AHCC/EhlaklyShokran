...
using EhlaklyShokran.Application.Features.Customers.Commands.CreateCustomer;
using EhlaklyShokran.Application.Features.Customers.Commands.RemoveCustomer;
using EhlaklyShokran.Application.Features.Customers.Commands.UpdateCustomer;
using EhlaklyShokran.Application.Features.Customers.Dtos;
using EhlaklyShokran.Application.Features.Customers.Queries.GetCustomerById;
using EhlaklyShokran.Application.Features.Customers.Queries.GetCustomers;
...
using EhlaklyShokran.Contracts.Requests.Customers;
