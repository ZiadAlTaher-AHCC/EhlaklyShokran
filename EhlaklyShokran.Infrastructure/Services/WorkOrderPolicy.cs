...
namespace EhlaklyShokran.Infrastructure.Services
{
    public class WorkOrderPolicy(IOptions<AppSettings> options, IApplicationDbContext context) : IWorkOrderPolicy
    {
        ...
        public async Task<bool> IsCustomerAlreadyScheduled(
            Guid customerId,
