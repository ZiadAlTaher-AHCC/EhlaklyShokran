...
{
    public class RefreshTokenQueryHandler(ILogger<RefreshTokenQueryHandler> logger, IIdentityService identityService, IApplicationDbContext context, ITokenProvider tokenProvider)
