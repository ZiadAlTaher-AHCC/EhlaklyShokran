    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BarberTasks", x => x.Id)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BarberTaskId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedAtUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    LastModifiedUtc = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: true)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Cosmetics", x => x.Id)
                        .Annotation("SqlServer:Clustered", false);
                    table.ForeignKey(
                        name: "FK_Cosmetics_BarberTasks_BarberTaskId",
                        column: x => x.BarberTaskId,
                        principalTable: "BarberTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateTable(
                name: "WorkOrderBarberTasks",
                columns: table => new
                {
                    BarberTasksId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    WorkOrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkOrderBarberTasks", x => new { x.BarberTasksId, x.WorkOrderId });
                    table.ForeignKey(
                        name: "FK_WorkOrderBarberTasks_BarberTasks_BarberTasksId",
                        column: x => x.BarberTasksId,
                        principalTable: "BarberTasks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkOrderBarberTasks_WorkOrders_WorkOrderId",
                        column: x => x.WorkOrderId,
                        principalTable: "WorkOrders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Cosmetics_BarberTaskId",
                table: "Cosmetics",
                column: "BarberTaskId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderBarberTasks_WorkOrderId",
                table: "WorkOrderBarberTasks",
                column: "WorkOrderId");
